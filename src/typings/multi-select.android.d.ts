...
declare module com {
	export module abdeveloper {
		export module library {
			...
			export module MultiSelectDialog {
...
declare module com {
	export module abdeveloper {
		export module library {
			...
			export module MutliSelectAdapter {
	...
	export module abdeveloper {
		export module library {
			export class RecyclerViewEmptySupport {
				...
				public setAdapter(param0: globalAndroid.support.v7.widget.RecyclerView.Adapter): void;
			}
		}
	}
}
